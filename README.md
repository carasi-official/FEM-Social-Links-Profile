...
Take the provided design files and turn them into a web site users can interact with (hover states). The trick to this particular assignment was the custom hover cursor image.
